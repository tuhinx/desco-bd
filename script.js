...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .screenshot-item, .advanced-feature-card');
...
document.addEventListener('DOMContentLoaded', () => {
    const advancedFeatureCards = document.querySelectorAll('.advanced-feature-card');
